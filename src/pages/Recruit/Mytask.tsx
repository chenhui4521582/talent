...
import {
  Card, Form, Select, Row, Col, Divider, Modal, InputNumber, notification
} from 'antd';
        ...
        >
          ...
          >
            <Select placeholder="请设置星级">
              {
                [1, 2, 3, 4, 5].map(item => {
                  return <Select.Option key={item} value={item}>{item}星</Select.Option>
                })
              }
            </Select>
          </Form.Item>
          ...
          >
            <InputNumber placeholder="请填写奖励金额" style={{width: '100%'}} />
          </Form.Item>
        </Form>
      </Modal>
    </Card>
