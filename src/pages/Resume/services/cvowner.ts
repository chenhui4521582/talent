...
export async function queryMyResume(params) { // 我的简历
...
export async function removeResume(params: IDeleteResume) { // 删除简历
...
export async function selectDemand() { // 所有进行中需求列表下拉框
...
export async function listResumeRecord(resumeId: string) { // 简历变更记录
...
export async function updateResumeStatus(params: IUpdateResume) { // 已下载简历状态变更
